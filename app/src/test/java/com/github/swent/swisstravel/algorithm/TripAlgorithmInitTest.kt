...
//    // Given: 1 child
//    val settings =
//        TripSettings(travelers = TripTravelers(adults = 2, children = 1), preferences =
// emptyList())
//
//    // When
...
//    val settings =
//        TripSettings(travelers = TripTravelers(adults = 1, children = 0), preferences =
// emptyList())
//
//    // When
//    val algo = TripAlgorithm.init(settings, repository, context)
...
//    val settings =
//        TripSettings(travelers = TripTravelers(adults = 3, children = 0), preferences =
// emptyList())
//
//    // When
//    val algo = TripAlgorithm.init(settings, repository, context)
...
//    val settings =
//        TripSettings(travelers = TripTravelers(adults = 2, children = 0), preferences =
// emptyList())
//
//    // When
//    val algo = TripAlgorithm.init(settings, repository, context)
...
//
//  /**
//   * Helper to extract the TripSettings using reflection, allowing us to verify the state inside
// the
