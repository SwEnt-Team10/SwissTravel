...
//  * 27) Verify that the trip is deleted (To find all the steps in the code you can do ctrl + f
// with
//  *     "step_number)")
//  */
...
//     val trips = runBlocking { repository.getAllTrips() } // Make sure that edit updated the UI
// too
...
//     // Verify bottom navigation visible
//     composeTestRule.checkNavigationMenuIsDisplayed()
//     composeTestRule.checkCurrentTripScreenEmptyIsDisplayed() // Because no current trip in my
// trips
//
//     /* 24) */
//     // Go to My Trips
...
//             name =
//                 "École Polytechnique Fédérale de Lausanne (EPFL), Route Cantonale, 1015
// Lausanne",
//             imageUrl = null)
//
