...
//   * 1. Alice Setup & Friend Request: Log in, create account, add Bob. 1.5. Bob Accepts: Bob
// accepts
//   *    friend request.
...
//    // Bob is a collaborator, so he should see the Trip details but NOT the Edit button (Owner
// only)
