...
class LikedActivitiesScreenTest {
    ...
    fun likedActivitiesScreenComponentsAreDisplayed() {
        composeTestRule
            .onNodeWithTag(LikedActivitiesScreenTestTags.SCREEN_TITLE)
            .assertIsDisplayed()
        composeTestRule.onNodeWithTag(LikedActivitiesScreenTestTags.BACK_BUTTON)
            .assertIsDisplayed()
    }
    ...
    fun listIsDisplayedWhenNotEmpty() {
        ...
        composeTestRule.onNodeWithTag(LikedActivitiesScreenTestTags.LIKED_ACTIVITIES_LIST).assertIsDisplayed()
    }
}