...
class ArrivalDepartureTest {
    ...
    private val fakeTripSettingsViewModel = TripSettingsViewModel(FakeTripsRepository(), FakeUserRepository())
    ...
    fun arrivalDepartureScreenIsDisplayed() {
        ...
        composeTestRule.onNodeWithTag(ArrivalDepartureTestTags.ARRIVAL_TEXTFIELD, useUnmergedTree = true).assertIsDisplayed()
        composeTestRule.onNodeWithTag(ArrivalDepartureTestTags.DEPARTURE_TEXTFIELD, useUnmergedTree = true).assertIsDisplayed()
    ...
    fun selectingSuggestionUpdatesState() {
        ...
        composeTestRule.onNode(
            hasTestTag(ArrivalDepartureTestTags.ARRIVAL_TEXTFIELD),
