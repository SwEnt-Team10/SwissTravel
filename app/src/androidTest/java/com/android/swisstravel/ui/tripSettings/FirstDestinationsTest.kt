...
class FirstDestinationsTest {
    ...
    fun addDestinationButtonAddsNewTextField() {
        ...
        composeTestRule.onAllNodesWithTag(AddressTextTestTags.INPUT_LOCATION).onFirst().assertIsDisplayed()
    }
    ...
    fun clickingNextUpdatesViewModelAndTriggersOnNext() {
        ...
        composeTestRule.onAllNodesWithTag(AddressTextTestTags.LOCATION_SUGGESTION).onFirst().performClick()
        ...
        val expectedLocation = fakeAddressVm.addressState.value.locationSuggestions.first() // Get the location from the fake
