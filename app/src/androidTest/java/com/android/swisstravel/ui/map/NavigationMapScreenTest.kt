...
class NavigationMapScreenTest {
    ...
    fun mapScreen_showsPermissionButton_whenPermissionDenied() {
        ...
        composeTestRule.setContent {
            MapScreen(navController = mockNavController)
        }

        composeTestRule.onNodeWithTag(NavigationMapScreenTestTags.PERMISSION_BUTTON)
            .assertIsDisplayed()
            .performClick()
    }
    ...
    fun mapScreen_showsBottomSheet_whenPermissionGranted() {
        ...
        composeTestRule.onNodeWithTag(NavigationMapScreenTestTags.BOTTOM_SHEET)
            .assertIsDisplayed()
    }
    ...
    fun bottomSheet_exitNavigationButton_navigatesBack() {
        composeTestRule.setContent {
            BottomSheet(navController = mockNavController)
        }

        composeTestRule.onNodeWithTag(NavigationMapScreenTestTags.EXIT_BUTTON)
            .assertIsDisplayed()
            .performClick()
    ...
    fun sampleMenu_buttonNavigatesToMap() {
        composeTestRule.setContent {
            SampleMenu(navController = mockNavController)
        }

        composeTestRule.onNodeWithText(NavigationMapScreenTestTags.ENTER_BUTTON)
            .assertIsDisplayed()
            .performClick()
