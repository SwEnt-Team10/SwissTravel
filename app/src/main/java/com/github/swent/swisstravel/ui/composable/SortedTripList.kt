...
// TODO: Remove later but I will need to do something similar for other screens so I keep it for now
/// **
...
// * @param onClickDropDownMenu the action to perform when a sort option is selected from the
// dropdown
// *   menu
// */
